...
.method public beginOperation(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    :cond_5e
    invoke-virtual {p0, v1}, Lio/requery/android/database/sqlite/SQLiteConnection$OperationLog;->newOperationCookieLocked(I)I
...
.method public endOperation(I)V
    ...
    :try_start_3
    invoke-virtual {p0, p1}, Lio/requery/android/database/sqlite/SQLiteConnection$OperationLog;->endOperationDeferLogLocked(I)Z
    ...
    invoke-virtual {p0, p1, v1}, Lio/requery/android/database/sqlite/SQLiteConnection$OperationLog;->logOperationLocked(ILjava/lang/String;)V
...
.method public final endOperationDeferLogLocked(I)Z
    ...
    invoke-virtual {p0, p1}, Lio/requery/android/database/sqlite/SQLiteConnection$OperationLog;->getOperationLocked(I)Lio/requery/android/database/sqlite/SQLiteConnection$Operation;
...
.method public final getOperationLocked(I)Lio/requery/android/database/sqlite/SQLiteConnection$Operation;
    .registers 3
...
.method public logOperation(ILjava/lang/String;)V
    ...
    :try_start_3
    invoke-virtual {p0, p1, p2}, Lio/requery/android/database/sqlite/SQLiteConnection$OperationLog;->logOperationLocked(ILjava/lang/String;)V
