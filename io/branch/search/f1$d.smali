.class public final Lio/branch/search/f1$d;
.super Ln4/j;
.source ""
...
# direct methods
.method public constructor <init>(Lio/branch/search/f1;Lio/branch/search/BranchAutoSuggestRequest;Lio/branch/search/IBranchAutoSuggestEvents;Ll4/d;)V
    .registers 5

    iput-object p1, p0, Lio/branch/search/f1$d;->d:Lio/branch/search/f1;

    iput-object p2, p0, Lio/branch/search/f1$d;->e:Lio/branch/search/BranchAutoSuggestRequest;

    iput-object p3, p0, Lio/branch/search/f1$d;->f:Lio/branch/search/IBranchAutoSuggestEvents;
...
.method public final create(Ljava/lang/Object;Ll4/d;)Ll4/d;
    ...
    new-instance p1, Lio/branch/search/f1$d;

    iget-object v0, p0, Lio/branch/search/f1$d;->d:Lio/branch/search/f1;

    iget-object v1, p0, Lio/branch/search/f1$d;->e:Lio/branch/search/BranchAutoSuggestRequest;

    iget-object p0, p0, Lio/branch/search/f1$d;->f:Lio/branch/search/IBranchAutoSuggestEvents;

    invoke-direct {p1, v0, v1, p0, p2}, Lio/branch/search/f1$d;-><init>(Lio/branch/search/f1;Lio/branch/search/BranchAutoSuggestRequest;Lio/branch/search/IBranchAutoSuggestEvents;Ll4/d;)V
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lio/branch/search/f1$d;->create(Ljava/lang/Object;Ll4/d;)Ll4/d;

    move-result-object p0

    check-cast p0, Lio/branch/search/f1$d;

    sget-object p1, Lh4/z;->a:Lh4/z;

    invoke-virtual {p0, p1}, Lio/branch/search/f1$d;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v1, p0, Lio/branch/search/f1$d;->c:I
    ...
    :cond_19
    iget-object v1, p0, Lio/branch/search/f1$d;->b:Ljava/lang/Object;

    check-cast v1, Lkotlin/jvm/internal/Ref$ObjectRef;

    iget-object v3, p0, Lio/branch/search/f1$d;->a:Ljava/lang/Object;
    ...
    iget-object v4, p0, Lio/branch/search/f1$d;->d:Lio/branch/search/f1;

    sget-object v5, Lio/branch/search/t5;->l:Lio/branch/search/t5;
    ...
    iget-object p1, p0, Lio/branch/search/f1$d;->e:Lio/branch/search/BranchAutoSuggestRequest;

    iget-object v7, p0, Lio/branch/search/f1$d;->d:Lio/branch/search/f1;
    ...
    iget-object v8, p0, Lio/branch/search/f1$d;->d:Lio/branch/search/f1;
    ...
    iget-object v9, p0, Lio/branch/search/f1$d;->d:Lio/branch/search/f1;
    ...
    iget-object v10, p0, Lio/branch/search/f1$d;->d:Lio/branch/search/f1;
    ...
    iput-object v1, p0, Lio/branch/search/f1$d;->a:Ljava/lang/Object;

    iput-object v1, p0, Lio/branch/search/f1$d;->b:Ljava/lang/Object;

    iput v3, p0, Lio/branch/search/f1$d;->c:I
    ...
    iget-object v4, p0, Lio/branch/search/f1$d;->e:Lio/branch/search/BranchAutoSuggestRequest;
    ...
    new-instance v1, Lio/branch/search/f1$d$a;

    const/4 v4, 0x0

    invoke-direct {v1, p0, v3, v4}, Lio/branch/search/f1$d$a;-><init>(Lio/branch/search/f1$d;Lkotlin/jvm/internal/Ref$ObjectRef;Ll4/d;)V

    iput-object v4, p0, Lio/branch/search/f1$d;->a:Ljava/lang/Object;

    iput-object v4, p0, Lio/branch/search/f1$d;->b:Ljava/lang/Object;

    iput v2, p0, Lio/branch/search/f1$d;->c:I
