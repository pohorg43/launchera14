...
.field public B:Lio/branch/search/z3;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/branch/search/BranchConfiguration;->B:Lio/branch/search/z3;
...
.method public static b(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, "https://vulcan4.branch.io/configuration/"
...
.method public a(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1, v0}, Lio/branch/search/BranchConfiguration;->a(Landroid/content/Context;Lio/branch/search/m;)V
...
.method public final a(Landroid/content/Context;Lio/branch/search/BranchConfiguration;Lio/branch/search/BranchConfiguration$d;)V
    ...
    .param p2  # Lio/branch/search/BranchConfiguration;
        ...
        .end annotation
    .end param
    .param p3  # Lio/branch/search/BranchConfiguration$d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public a(Lio/branch/search/p;)V
    .registers 2
    .param p1  # Lio/branch/search/p;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public a(Lorg/json/JSONObject;Landroid/content/Context;Lio/branch/search/KBranchRemoteConfiguration;)V
    ...
    .param p2  # Landroid/content/Context;
        ...
        .end annotation
    .end param
    .param p3  # Lio/branch/search/KBranchRemoteConfiguration;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    monitor-exit p3
    :try_end_15
    .catchall {:try_start_3 .. :try_end_15} :catchall_17c
    ...
    :try_end_174
    .catch Lorg/json/JSONException; {:try_start_15 .. :try_end_174} :catch_175
...
.method public addRequestExtra(Ljava/lang/String;Ljava/lang/Object;)V
    .registers 3
    .param p1  # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iget-object p0, p0, Lio/branch/search/BranchConfiguration;->p:Ljava/util/Map;
...
.method public b(Lio/branch/search/p;)V
    .registers 2
    .param p1  # Lio/branch/search/p;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public i()Ljava/lang/String;
    ...
    iget-object p0, p0, Lio/branch/search/BranchConfiguration;->w:Ljava/lang/String;
    ...
    :cond_5
    const-string p0, "https://vulcan.branch.io/v3/queryhint"
...
.method public optOutOfLocalContent(Z)Lio/branch/search/BranchConfiguration;
    .registers 2
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method public final s()V
    ...
    check-cast v1, Lio/branch/search/p;

    invoke-interface {v1, p0}, Lio/branch/search/p;->a(Lio/branch/search/BranchConfiguration;)V
...
.method public setAppDataOverrideHandler(Lio/branch/search/IBranchAppDataOverrideHandler;)Lio/branch/search/BranchConfiguration;
    .registers 2

    iput-object p1, p0, Lio/branch/search/BranchConfiguration;->s:Lio/branch/search/IBranchAppDataOverrideHandler;
...
.method public setBrandToAttribute(Ljava/lang/String;)Lio/branch/search/BranchConfiguration;
    .registers 2

    iput-object p1, p0, Lio/branch/search/BranchConfiguration;->l:Ljava/lang/String;

    return-object p0
.end method

.method public setCarrierToAttribute(Ljava/lang/String;)Lio/branch/search/BranchConfiguration;
    .registers 2

    iput-object p1, p0, Lio/branch/search/BranchConfiguration;->k:Ljava/lang/String;

    return-object p0
.end method

.method public setCountryToAttribute(Ljava/lang/String;)Lio/branch/search/BranchConfiguration;
    .registers 2
    .param p1  # Ljava/lang/String;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    iput-object p1, p0, Lio/branch/search/BranchConfiguration;->j:Ljava/lang/String;

    return-object p0
.end method

.method public setCustomAttribution(Ljava/util/Map;)Lio/branch/search/BranchConfiguration;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lio/branch/search/BranchConfiguration;"
        }
    .end annotation

    iput-object p1, p0, Lio/branch/search/BranchConfiguration;->n:Ljava/util/Map;

    return-object p0
.end method

.method public setDeepViewHandler(Lio/branch/search/IBranchDeepViewHandler;)Lio/branch/search/BranchConfiguration;
    .registers 2
    .param p1  # Lio/branch/search/IBranchDeepViewHandler;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/NonNull;
    ...
    iput-object p1, p0, Lio/branch/search/BranchConfiguration;->r:Lio/branch/search/IBranchDeepViewHandler;

    return-object p0
.end method

.method public setIntentHandler(Lio/branch/search/IBranchIntentHandler;)Lio/branch/search/BranchConfiguration;
    .registers 2
    .param p1  # Lio/branch/search/IBranchIntentHandler;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/NonNull;
    ...
    iput-object p1, p0, Lio/branch/search/BranchConfiguration;->t:Lio/branch/search/IBranchIntentHandler;

    return-object p0
.end method

.method public setLaunchIntentFlags(I)Lio/branch/search/BranchConfiguration;
    .registers 2
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    iput p1, p0, Lio/branch/search/BranchConfiguration;->o:I

    return-object p0
.end method

.method public setModelToAttribute(Ljava/lang/String;)Lio/branch/search/BranchConfiguration;
    .registers 2

    iput-object p1, p0, Lio/branch/search/BranchConfiguration;->m:Ljava/lang/String;

    return-object p0
.end method

.method public setShortcutHandler(Lio/branch/search/IBranchShortcutHandler;)Lio/branch/search/BranchConfiguration;
    .registers 2
    .param p1  # Lio/branch/search/IBranchShortcutHandler;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/NonNull;
    ...
    iput-object p1, p0, Lio/branch/search/BranchConfiguration;->q:Lio/branch/search/IBranchShortcutHandler;

    return-object p0
.end method

.method public setUrl(Ljava/lang/String;)Lio/branch/search/BranchConfiguration;
    .registers 2
    .param p1  # Ljava/lang/String;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    iput-object p1, p0, Lio/branch/search/BranchConfiguration;->u:Ljava/lang/String;
...
.method public trackingStatus(Lio/branch/search/BranchConfiguration$BranchTrackingStatus;)Lio/branch/search/BranchConfiguration;
    .registers 5
    .param p1  # Lio/branch/search/BranchConfiguration$BranchTrackingStatus;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    new-instance v0, Lio/branch/search/z3;
    ...
    invoke-direct {v0, p1, v1, v2}, Lio/branch/search/z3;-><init>(IJ)V
