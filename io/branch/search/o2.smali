.class public Lio/branch/search/o2;
...
# instance fields
.field public final a:Lio/branch/search/a2$l;


# direct methods
.method public constructor <init>(Lio/branch/search/a2$l;)V
    .registers 2
    .param p1  # Lio/branch/search/a2$l;
    ...
    iput-object p1, p0, Lio/branch/search/o2;->a:Lio/branch/search/a2$l;
...
.method public a(Lio/requery/android/database/sqlite/SQLiteDatabase;)V
    ...
    iget-object v2, v0, Lio/branch/search/o2;->a:Lio/branch/search/a2$l;

    iget-object v2, v2, Lio/branch/search/a2$l;->b:Ljava/util/List;
    ...
    check-cast v3, Lio/branch/search/a2$k;

    iget-object v5, v3, Lio/branch/search/a2$k;->a:Ljava/lang/String;
    ...
    iget-object v3, v3, Lio/branch/search/a2$k;->b:Ljava/util/List;
    ...
    invoke-virtual {v5}, Lio/requery/android/database/sqlite/SQLiteProgram;->clearBindings()V
    ...
    invoke-virtual {v5, v7}, Lio/requery/android/database/sqlite/SQLiteProgram;->bindNull(I)V
    ...
    invoke-virtual {v5, v7, v8, v9}, Lio/requery/android/database/sqlite/SQLiteProgram;->bindDouble(ID)V
    ...
    invoke-virtual {v5, v7, v8, v9}, Lio/requery/android/database/sqlite/SQLiteProgram;->bindLong(IJ)V
    ...
    invoke-virtual {v5, v7, v8}, Lio/requery/android/database/sqlite/SQLiteProgram;->bindString(ILjava/lang/String;)V
    ...
    invoke-virtual {v5}, Lio/requery/android/database/sqlite/SQLiteClosable;->close()V
    ...
    iget-object v2, v2, Lio/branch/search/a2$l;->e:Ljava/util/Map;
    ...
    iget-object v2, v2, Lio/branch/search/a2$l;->c:Ljava/util/List;
    ...
    check-cast v3, Lio/branch/search/a2$h;

    new-instance v13, Landroid/content/ContentValues;

    invoke-direct {v13}, Landroid/content/ContentValues;-><init>()V

    iget-object v14, v3, Lio/branch/search/a2$h;->a:Ljava/lang/String;

    invoke-virtual {v13, v9, v14}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v14, v3, Lio/branch/search/a2$h;->b:Ljava/lang/String;

    invoke-virtual {v13, v12, v14}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v12, v3, Lio/branch/search/a2$h;->c:Ljava/lang/String;
    ...
    :cond_144
    iget-object v0, v0, Lio/branch/search/o2;->a:Lio/branch/search/a2$l;

    iget-object v0, v0, Lio/branch/search/a2$l;->d:Ljava/util/List;
    ...
    check-cast v2, Lio/branch/search/a2$i;

    new-array v3, v4, [Ljava/lang/String;

    iget-object v13, v2, Lio/branch/search/a2$i;->a:Ljava/lang/String;
    ...
    iget-object v3, v2, Lio/branch/search/a2$i;->b:Ljava/util/List;
