...
.method public static constructor <clinit>()V
    ...
    const-string v3, "ToggleAndUndo"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Landroidx/recyclerview/widget/MultipleChoiceDragSelectionProcessor$ModeType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "FirstItemDependent"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Landroidx/recyclerview/widget/MultipleChoiceDragSelectionProcessor$ModeType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Landroidx/recyclerview/widget/MultipleChoiceDragSelectionProcessor$ModeType;->FirstItemDependent:Landroidx/recyclerview/widget/MultipleChoiceDragSelectionProcessor$ModeType;

    new-instance v5, Landroidx/recyclerview/widget/MultipleChoiceDragSelectionProcessor$ModeType;

    const-string v7, "FirstItemDependentToggleAndUndo"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Landroidx/recyclerview/widget/MultipleChoiceDragSelectionProcessor$ModeType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Landroidx/recyclerview/widget/MultipleChoiceDragSelectionProcessor$ModeType;->FirstItemDependentToggleAndUndo:Landroidx/recyclerview/widget/MultipleChoiceDragSelectionProcessor$ModeType;

    const/4 v7, 0x4

    new-array v7, v7, [Landroidx/recyclerview/widget/MultipleChoiceDragSelectionProcessor$ModeType;
    ...
    sput-object v7, Landroidx/recyclerview/widget/MultipleChoiceDragSelectionProcessor$ModeType;->$VALUES:[Landroidx/recyclerview/widget/MultipleChoiceDragSelectionProcessor$ModeType;
