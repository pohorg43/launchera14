...
.method public read(Landroid/content/Context;Lcom/android/launcher3/util/PersistedItemArray$ItemFactory;)Ljava/util/List;
    ...
    invoke-direct {v1, v0}, Lcom/android/launcher3/util/o;-><init>(Lcom/android/launcher3/pm/UserCache;)V
...
.method public read(Landroid/content/Context;Lcom/android/launcher3/util/PersistedItemArray$ItemFactory;Ljava/util/function/LongFunction;)Ljava/util/List;
    ...
    move-result-object p1
    :try_end_d
    .catch Ljava/io/FileNotFoundException; {:try_start_5 .. :try_end_d} :catch_a5
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_d} :catch_8b
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_5 .. :try_end_d} :catch_8b
    ...
    move-result v3
    :try_end_41
    .catchall {:try_start_d .. :try_end_41} :catchall_7f
    ...
    :try_end_78
    .catch Ljava/lang/Exception; {:try_start_44 .. :try_end_78} :catch_24
    .catchall {:try_start_44 .. :try_end_78} :catchall_7f
    ...
    :try_end_7e
    .catch Ljava/io/FileNotFoundException; {:try_start_7b .. :try_end_7e} :catch_a5
    .catch Ljava/io/IOException; {:try_start_7b .. :try_end_7e} :catch_8b
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_7b .. :try_end_7e} :catch_8b
    ...
    throw p2
    :try_end_8b
    .catch Ljava/io/FileNotFoundException; {:try_start_87 .. :try_end_8b} :catch_a5
    .catch Ljava/io/IOException; {:try_start_87 .. :try_end_8b} :catch_8b
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_87 .. :try_end_8b} :catch_8b

    :catch_8b
    move-exception p1

    const-string p2, "Unable to read items in "
...
.method public write(Landroid/content/Context;Ljava/util/List;)V
    ...
    move-result-object v5
    :try_end_10
    .catch Ljava/io/IOException; {:try_start_c .. :try_end_10} :catch_94
    ...
    :try_end_77
    .catch Ljava/io/IOException; {:try_start_18 .. :try_end_77} :catch_7b
