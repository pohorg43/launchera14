...
.method public static synthetic l(Lcom/android/launcher3/model/BgDataModel;Lcom/android/launcher3/LauncherAppState;Landroid/os/UserHandle;)V
    .registers 3
...
.method public static synthetic m(Lcom/android/launcher3/model/data/ItemInfo;)Z
    .registers 1
...
.method public static synthetic n(Landroid/os/UserHandle;Landroid/content/ComponentName;Lcom/android/launcher3/model/data/AppInfo;)Z
    .registers 3
...
.method public static synthetic o(Lcom/android/launcher3/LauncherAppState;Landroid/content/Context;Lcom/android/launcher3/model/data/AppInfo;)Lcom/android/launcher3/model/data/WorkspaceItemInfo;
    .registers 3
...
.method public static synthetic p(Landroid/content/Context;Landroid/content/ComponentName;Landroid/os/UserHandle;Lcom/android/launcher3/LauncherAppState;)Lcom/android/launcher3/model/data/WorkspaceItemInfo;
    .registers 4
...
.method public static synthetic q(Lcom/android/launcher3/model/data/ItemInfo;)Landroid/os/UserHandle;
    .registers 1
...
.method public execute(Lcom/android/launcher3/LauncherAppState;Lcom/android/launcher3/model/BgDataModel;Lcom/android/launcher3/model/AllAppsList;)V
    ...
    sget-object v2, Lcom/android/launcher3/model/n1;->b:Lcom/android/launcher3/model/n1;

    invoke-interface {v1, v2}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v1

    sget-object v2, Lcom/android/launcher3/model/m1;->b:Lcom/android/launcher3/model/m1;
    ...
    new-instance v7, Lcom/android/launcher3/k3;

    invoke-direct {v7, v4, v6}, Lcom/android/launcher3/k3;-><init>(Landroid/os/UserHandle;Landroid/content/ComponentName;)V

    invoke-interface {v5, v7}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v5

    new-instance v7, Lcom/android/launcher3/model/d2;

    invoke-direct {v7, p1, v0}, Lcom/android/launcher3/model/d2;-><init>(Lcom/android/launcher3/LauncherAppState;Landroid/content/Context;)V
    ...
    new-instance v7, Lcom/android/launcher3/model/o1;

    invoke-direct {v7, v0, v6, v4, p1}, Lcom/android/launcher3/model/o1;-><init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/os/UserHandle;Lcom/android/launcher3/LauncherAppState;)V
    ...
    new-instance p3, Lcom/android/launcher/model/b;

    invoke-direct {p3, p2, p1}, Lcom/android/launcher/model/b;-><init>(Lcom/android/launcher3/model/BgDataModel;Lcom/android/launcher3/LauncherAppState;)V
