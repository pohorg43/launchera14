...
.field public mIsGlobalDragging:Z
...
.method public callOnDragStart()V
    ...
    const-string v1, "dragView is null"
...
.method public drop(Lcom/android/launcher3/DropTarget;Ljava/lang/Runnable;)V
    ...
    :cond_49
    invoke-virtual {p0, v2, p1}, Lcom/android/launcher3/dragndrop/DragController;->dropTraceLayoutInject(ZLcom/android/launcher3/DropTarget;)V
...
.method public endDrag()V
    ...
    const-string v2, "endDrag,isDeferred="

    const-string v3, ", mIsInPreDrag="
    ...
    const-string v4, "DragController"
    ...
    iget-object v3, v2, Lcom/android/launcher3/DropTarget$DragObject;->originalView:Lcom/android/launcher3/dragndrop/DraggableView;
...
.method public getLogInstanceId()Ljava/util/Optional;
    ...
    sget-object v0, Lcom/android/launcher3/dragndrop/i;->a:Lcom/android/launcher3/dragndrop/i;
