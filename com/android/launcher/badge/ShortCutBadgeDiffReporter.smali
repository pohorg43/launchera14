.class public Lcom/android/launcher/badge/ShortCutBadgeDiffReporter;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/launcher/badge/ShortCutBadgeDiffReporter$DiffResult;
    }
.end annotation


# static fields
.field private static final TAG:Ljava/lang/String; = "ShortCutBadgeInfoDiffReporter"


# instance fields
.field private mDiffResult:Lcom/android/launcher/badge/ShortCutBadgeDiffReporter$DiffResult;


# direct methods
.method public constructor <init>(Lcom/android/launcher/badge/ShortCutBadgeDiffReporter$DiffResult;)V
    .registers 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/android/launcher/badge/ShortCutBadgeDiffReporter;->mDiffResult:Lcom/android/launcher/badge/ShortCutBadgeDiffReporter$DiffResult;
...
.method private sendResult(Ljava/util/concurrent/ConcurrentHashMap;)V
    ...
    iget-object p0, p0, Lcom/android/launcher/badge/ShortCutBadgeDiffReporter;->mDiffResult:Lcom/android/launcher/badge/ShortCutBadgeDiffReporter$DiffResult;

    if-eqz p0, :cond_7

    invoke-interface {p0, p1}, Lcom/android/launcher/badge/ShortCutBadgeDiffReporter$DiffResult;->onResult(Ljava/util/concurrent/ConcurrentHashMap;)V
...
.method public process(Ljava/util/concurrent/ConcurrentHashMap;Ljava/util/concurrent/ConcurrentHashMap;)V
    ...
    const-string v2, "ShortCutBadgeInfoDiffReporter"
    ...
    invoke-direct {p0, p1}, Lcom/android/launcher/badge/ShortCutBadgeDiffReporter;->sendResult(Ljava/util/concurrent/ConcurrentHashMap;)V
    ...
    const-string/jumbo v7, "遍历老的shortcut集合：orgDotInfoEntry is ："
    ...
    check-cast v6, Lcom/android/launcher3/dot/DotUtils$ShortCutIdUserUidKey;
    ...
    const-string/jumbo v9, "以老的shortcut集合中的一个key在新集合中寻找目标：newDotInf is ："
    ...
    const-string/jumbo v9, "以老的shortcut集合中的一个key在新集合中寻找目标  找到了：newDotInf is ："
    ...
    const-string/jumbo v8, "老的集合和新的新集合中同key但是value不同 加入更新包中"
    ...
    check-cast v4, Lcom/android/launcher3/dot/DotUtils$ShortCutIdUserUidKey;
    ...
    const-string v5, "currDotInfo: key = "
    ...
    const-string/jumbo v5, "updateDotInfo: key = "
    ...
    :cond_1c3
    invoke-direct {p0, v0}, Lcom/android/launcher/badge/ShortCutBadgeDiffReporter;->sendResult(Ljava/util/concurrent/ConcurrentHashMap;)V
