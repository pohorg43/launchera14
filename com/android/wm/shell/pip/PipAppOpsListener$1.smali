.class Lcom/android/wm/shell/pip/PipAppOpsListener$1;
...
.method public static synthetic a(Lcom/android/wm/shell/pip/PipAppOpsListener$1;)V
    .registers 1
...
.method private synthetic lambda$onOpChanged$0()V
    ...
    invoke-static {p0}, Lcom/android/wm/shell/pip/PipAppOpsListener;->access$400(Lcom/android/wm/shell/pip/PipAppOpsListener;)Lcom/android/wm/shell/pip/PipAppOpsListener$Callback;
...
.method public onOpChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/android/wm/shell/pip/PipAppOpsListener;->access$000(Lcom/android/wm/shell/pip/PipAppOpsListener;)Landroid/content/Context;
    ...
    invoke-static {v0}, Lcom/android/wm/shell/pip/PipAppOpsListener;->access$000(Lcom/android/wm/shell/pip/PipAppOpsListener;)Landroid/content/Context;
    ...
    invoke-static {p1}, Lcom/android/wm/shell/pip/PipAppOpsListener;->access$100(Lcom/android/wm/shell/pip/PipAppOpsListener;)Landroid/app/AppOpsManager;
    ...
    invoke-static {p1}, Lcom/android/wm/shell/pip/PipAppOpsListener;->access$200(Lcom/android/wm/shell/pip/PipAppOpsListener;)Lcom/android/wm/shell/common/ShellExecutor;

    move-result-object p1

    new-instance p2, Lcom/android/wm/shell/pip/d;

    invoke-direct {p2, p0}, Lcom/android/wm/shell/pip/d;-><init>(Lcom/android/wm/shell/pip/PipAppOpsListener$1;)V

    invoke-interface {p1, p2}, Lcom/android/wm/shell/common/ShellExecutor;->execute(Ljava/lang/Runnable;)V
    :try_end_53
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_53} :catch_54
    ...
    invoke-static {p0}, Lcom/android/wm/shell/pip/PipAppOpsListener;->access$300(Lcom/android/wm/shell/pip/PipAppOpsListener;)V
