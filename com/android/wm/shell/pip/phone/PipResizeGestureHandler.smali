...
.method public constructor <init>(Landroid/content/Context;Lcom/android/wm/shell/pip/PipBoundsAlgorithm;Lcom/android/wm/shell/pip/PipBoundsState;Lcom/android/wm/shell/pip/phone/PipMotionHelper;Lcom/android/wm/shell/pip/phone/PipTouchState;Lcom/android/wm/shell/pip/PipTaskOrganizer;Lcom/android/wm/shell/pip/phone/PipDismissTargetHandler;Ljava/util/function/Function;Ljava/lang/Runnable;Lcom/android/wm/shell/pip/PipUiEventLogger;Lcom/android/wm/shell/pip/phone/PhonePipMenuController;Lcom/android/wm/shell/common/ShellExecutor;)V
    ...
    invoke-direct {p1, p0}, Lcom/android/wm/shell/pip/f;-><init>(Lcom/android/wm/shell/pip/phone/PipResizeGestureHandler;)V
...
.method public static synthetic c(Lcom/android/wm/shell/pip/phone/PipResizeGestureHandler;Landroid/graphics/Rect;)V
    .registers 2
...
.method private finishResize()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/wm/shell/pip/PipBoundsAlgorithm;->getMovementBounds(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    new-instance v7, Lcom/android/quickstep/c1;

    invoke-direct {v7, p0}, Lcom/android/quickstep/c1;-><init>(Lcom/android/wm/shell/pip/phone/PipResizeGestureHandler;)V
...
.method private updateIsEnabled()V
    ...
    invoke-direct {v1, p0}, Lcom/android/wm/shell/pip/phone/y;-><init>(Lcom/android/wm/shell/pip/phone/PipResizeGestureHandler;)V
...
.method public onInputEvent(Landroid/view/InputEvent;)V
    ...
    const-string/jumbo v0, "onInputEvent, pinch resize or drag corner resize, mEnableDragCornerResize = "

    invoke-static {v0}, Ld/c;->a(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v1, p0, Lcom/android/wm/shell/pip/phone/PipResizeGestureHandler;->mEnableDragCornerResize:Z
    ...
    const-string v1, ", mOngoingPinchToResize = "
    ...
    invoke-static {v1, v0}, Lcom/oplus/pip/util/LogUtil;->debugD(Ljava/lang/String;Ljava/lang/String;)V
...
.method public userResizeTo(Landroid/graphics/Rect;F)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/wm/shell/pip/PipBoundsAlgorithm;->getMovementBounds(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p1, v0, p2}, Lcom/android/wm/shell/pip/PipBoundsAlgorithm;->applySnapFraction(Landroid/graphics/Rect;F)V

    iget-object p1, p0, Lcom/android/wm/shell/pip/phone/PipResizeGestureHandler;->mPipTaskOrganizer:Lcom/android/wm/shell/pip/PipTaskOrganizer;

    iget-object p2, p0, Lcom/android/wm/shell/pip/phone/PipResizeGestureHandler;->mPipBoundsState:Lcom/android/wm/shell/pip/PipBoundsState;
    ...
    invoke-virtual {p1, p2}, Lcom/android/wm/shell/pip/PipBoundsState;->setHasUserResizedPip(Z)V
...
.method public willStartResizeGesture(Landroid/view/MotionEvent;)Z
    ...
    :cond_10
    const-string/jumbo v0, "should set mOngoingPinchToResize to true first, pointer count = "
