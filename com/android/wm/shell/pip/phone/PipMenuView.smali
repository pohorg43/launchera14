...
.method public constructor <init>(Landroid/content/Context;Lcom/android/wm/shell/pip/phone/PhonePipMenuController;Lcom/android/wm/shell/common/ShellExecutor;Landroid/os/Handler;Ljava/util/Optional;Lcom/android/wm/shell/pip/PipUiEventLogger;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/wm/shell/pip/phone/j0;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuView;I)V
    ...
    new-instance p4, Lcom/android/common/util/c1;

    invoke-direct {p4, p0}, Lcom/android/common/util/c1;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuView;)V
    ...
    new-instance p4, Lcom/android/launcher/u;

    invoke-direct {p4, p0}, Lcom/android/launcher/u;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuView;)V
    ...
    new-instance p4, Lcom/android/launcher/folder/recommend/a;

    invoke-direct {p4, p0}, Lcom/android/launcher/folder/recommend/a;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuView;)V
    ...
    new-instance p4, Lcom/android/launcher/guide/side/b;

    invoke-direct {p4, p0}, Lcom/android/launcher/guide/side/b;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuView;)V
...
.method public static synthetic c(Lcom/android/wm/shell/pip/phone/PipMenuView;)V
    .registers 1
...
.method private enterSplit()V
    ...
    invoke-direct {v1, v0, v2}, Lcom/android/wm/shell/pip/phone/i0;-><init>(Lcom/android/wm/shell/pip/phone/PhonePipMenuController;I)V

    const/4 v0, 0x1

    invoke-virtual {p0, v1, v2, v0, v0}, Lcom/android/wm/shell/pip/phone/PipMenuView;->hideMenu(Ljava/lang/Runnable;ZZI)V
...
.method private expandPip()V
    ...
    const-string v0, "PipMenuView"

    const-string v1, "expandPip: click expand button."
    ...
    invoke-direct {v1, v0}, Lcom/android/wm/shell/draganddrop/b;-><init>(Lcom/android/wm/shell/pip/phone/PhonePipMenuController;)V
...
.method public static synthetic i(Lcom/android/wm/shell/pip/phone/PipMenuView;Landroid/app/RemoteAction;ZLandroid/view/View;)V
    .registers 4
...
.method private synthetic lambda$new$2(Landroid/view/View;)V
    ...
    invoke-virtual {p1}, Lcom/android/wm/shell/pip/phone/PhonePipMenuController;->isMinimized()Z
    ...
    invoke-virtual {p1}, Lcom/android/wm/shell/pip/phone/PhonePipMenuController;->exitSplitScreenAndGoHome()V
...
.method private onActionViewClicked(Landroid/app/PendingIntent;Z)V
    ...
    invoke-static {v2, v3, v1, v4, v5}, Lcom/android/wm/shell/protolog/ShellProtoLogImpl;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p2, p0, v0}, Lcom/android/wm/shell/pip/phone/j0;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuView;I)V
...
.method private updateActionViews(ILandroid/graphics/Rect;)V
    ...
    sget-object v2, Lcom/android/wm/shell/pip/phone/h0;->a:Lcom/android/wm/shell/pip/phone/h0;
    ...
    new-instance v11, Lcom/android/wm/shell/pip/phone/f0;

    invoke-direct {v11, v7}, Lcom/android/wm/shell/pip/phone/f0;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuActionView;)V
    ...
    new-instance v9, Lcom/android/wm/shell/pip/phone/g0;

    invoke-direct {v9, p0, v1, v8}, Lcom/android/wm/shell/pip/phone/g0;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuView;Landroid/app/RemoteAction;Z)V
...
.method public onFocusTaskChanged(Landroid/app/ActivityManager$RunningTaskInfo;)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/wm/shell/splitscreen/SplitScreenController;->isTaskInSplitScreenForeground(I)Z
...
.method public showMenu(ILandroid/graphics/Rect;ZZZZ)V
    ...
    invoke-direct {v2, v0}, Lcom/android/wm/shell/pip/phone/y;-><init>(Lcom/android/wm/shell/pip/phone/PipMenuView;)V
