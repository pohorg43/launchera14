...
.field private static final SIZE_PERCENTAGE:F = 0.222f
...
.field private mFlyoutMaxWidth:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/wm/shell/bubbles/BubblePositioner;)V
    ...
    sget p2, Lcom/android/wm/shell/R$id;->bubble_flyout_text_container:I
    ...
    iput-object p2, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mFlyoutTextContainer:Landroid/view/ViewGroup;
    ...
    sget v4, Lcom/android/wm/shell/R$id;->bubble_flyout_avatar:I
    ...
    iput-object v4, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mSenderAvatar:Landroid/widget/ImageView;

    sget v4, Lcom/android/wm/shell/R$id;->bubble_flyout_text:I
    ...
    iput-object p2, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mMessageText:Landroid/widget/TextView;

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->getResources()Landroid/content/res/Resources;

    move-result-object v4

    sget v5, Lcom/android/wm/shell/R$dimen;->bubble_flyout_padding_x:I

    invoke-virtual {v4, v5}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v5

    iput v5, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mFlyoutPadding:I

    sget v5, Lcom/android/wm/shell/R$dimen;->bubble_flyout_space_from_bubble:I

    invoke-virtual {v4, v5}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v5

    iput v5, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mFlyoutSpaceFromBubble:I

    const/4 v5, 0x0

    iput v5, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mPointerSize:I

    sget v6, Lcom/android/wm/shell/R$dimen;->bubble_elevation:I

    invoke-virtual {v4, v6}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v6

    iput v6, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mBubbleElevation:I

    sget v6, Lcom/android/wm/shell/R$dimen;->bubble_flyout_elevation:I

    invoke-virtual {v4, v6}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v6

    iput v6, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mFlyoutElevation:I
    ...
    sget v8, Lcom/android/wm/shell/R$color;->bubble_flyout_view_bg_n:I
    ...
    :cond_a8
    sget v8, Lcom/android/wm/shell/R$color;->bubble_flyout_view_bg:I
    ...
    :goto_ae
    iput v8, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mFloatingBackgroundColor:I

    sget v9, Lcom/android/wm/shell/R$dimen;->bubble_flyout_expand_radius:I
    ...
    sget v4, Lcom/android/wm/shell/R$color;->bubble_flyout_sender_text_view_n:I
    ...
    :cond_c2
    sget v4, Lcom/android/wm/shell/R$color;->bubble_flyout_sender_text_view:I
    ...
    sget v3, Lcom/android/wm/shell/R$color;->bubble_flyout_message_text_view_n:I
    ...
    :cond_d4
    sget v3, Lcom/android/wm/shell/R$color;->bubble_flyout_message_text_view:I
    ...
    invoke-static {p2, v0, v2}, Lcom/android/wm/shell/common/TriangleShape;->createHorizontal(FFZ)Lcom/android/wm/shell/common/TriangleShape;
    ...
    invoke-virtual {p1, v5, v5, v5, v5}, Landroid/graphics/drawable/ShapeDrawable;->setBounds(IIII)V
    ...
    invoke-static {p2, v0, v5}, Lcom/android/wm/shell/common/TriangleShape;->createHorizontal(FFZ)Lcom/android/wm/shell/common/TriangleShape;
    ...
    iput p1, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mFullRadius:I

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget p2, Lcom/android/wm/shell/R$dimen;->bubble_flyout_width:I

    invoke-virtual {p1, p2}, Landroid/content/res/Resources;->getDimensionPixelOffset(I)I

    move-result p1

    iput p1, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mFlyoutMaxWidth:I

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mPath:Landroid/graphics/Path;
...
.method public static synthetic access$000(Lcom/android/wm/shell/bubbles/BubbleFlyoutView;Landroid/graphics/Outline;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->getOutlineCustom(Landroid/graphics/Outline;)V
...
.method private getInterpolatedRadius()F
    ...
    invoke-static {v2, v1, p0, v0}, Landroidx/appcompat/graphics/drawable/a;->a(FFFF)F
...
.method private getOutlineCustom(Landroid/graphics/Outline;)V
    .registers 16
    ...
    iget v12, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mFullRadius:I
...
.method private synthetic lambda$animateUpdate$1(Landroid/graphics/PointF;Z)V
    ...
    sget-object v0, Lcom/android/wm/shell/bubbles/n0;->a:Lcom/android/wm/shell/bubbles/n0;
...
.method private synthetic lambda$animateUpdate$2(Lcom/android/wm/shell/bubbles/Bubble$FlyoutMessage;Landroid/graphics/PointF;Z)V
    ...
    new-instance p1, Lcom/android/wm/shell/bubbles/b0;

    invoke-direct {p1, p0, p2, p3}, Lcom/android/wm/shell/bubbles/b0;-><init>(Lcom/android/wm/shell/bubbles/BubbleFlyoutView;Landroid/graphics/PointF;Z)V
...
.method private renderBackground(Landroid/graphics/Canvas;)V
    ...
    iget v2, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mTranslationXWhenDot:F

    iget v3, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mPercentTransitionedToDot:F

    mul-float/2addr v2, v3

    iput v2, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mBgTranslationX:F

    iget v2, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mTranslationYWhenDot:F

    mul-float/2addr v2, v3

    iput v2, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mBgTranslationY:F
    ...
    iget-object v3, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mArgbEvaluator:Landroid/animation/ArgbEvaluator;
    ...
    invoke-virtual {v3, v4, v6, v7}, Landroid/animation/ArgbEvaluator;->evaluate(FLjava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mPath:Landroid/graphics/Path;
    ...
    iget-object v11, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mBgRect:Landroid/graphics/RectF;
...
.method private updateFlyoutMessage(Lcom/android/wm/shell/bubbles/Bubble$FlyoutMessage;)V
    ...
    iget v2, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mFlyoutMaxWidth:I
    ...
    iget v1, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mFlyoutMaxWidth:I

    iget v2, p0, Lcom/android/wm/shell/bubbles/BubbleFlyoutView;->mFlyoutPadding:I
...
.method public animateUpdate(Lcom/android/wm/shell/bubbles/Bubble$FlyoutMessage;Landroid/graphics/PointF;Z[FLjava/lang/Runnable;)V
    ...
    new-instance p4, Lcom/android/common/util/k0;

    invoke-direct {p4, p0, p1, p2, p3}, Lcom/android/common/util/k0;-><init>(Lcom/android/wm/shell/bubbles/BubbleFlyoutView;Lcom/android/wm/shell/bubbles/Bubble$FlyoutMessage;Landroid/graphics/PointF;Z)V
...
.method public setupFlyoutStartingAsDot(Lcom/android/wm/shell/bubbles/Bubble$FlyoutMessage;Landroid/graphics/PointF;ZILjava/lang/Runnable;Ljava/lang/Runnable;[FZ)V
    ...
    new-instance p1, Lcom/android/common/util/k0;

    invoke-direct {p1, p0, p2, p8, p5}, Lcom/android/common/util/k0;-><init>(Lcom/android/wm/shell/bubbles/BubbleFlyoutView;Landroid/graphics/PointF;ZLjava/lang/Runnable;)V
