.class public Lcom/pantanal/server/content/upkmanage/database/a$c;
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string p0, "UPDATE OR ABORT `UpkEntity` SET `_id` = ?,`service_id` = ?,`hashed_service_id` = ?,`package_name` = ?,`label` = ?,`icons` = ?,`version_code` = ?,`version_name` = ?,`files_directory_path` = ?,`last_launch_time` = ?,`click_json_string` = ?,`host_package_name` = ?,`host_component_name` = ?,`install_time` = ?,`use_template` = ? WHERE `_id` = ?"
