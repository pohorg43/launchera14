...
.method public constructor <init>(Lcom/oplus/anim/EffectiveAnimationDrawable;Lcom/oplus/anim/model/layer/Layer;)V
    ...
    iput-object p1, p0, Lcom/oplus/anim/model/layer/SolidLayer;->rect:Landroid/graphics/RectF;

    new-instance p1, Lcom/oplus/anim/animation/LPaint;

    invoke-direct {p1}, Lcom/oplus/anim/animation/LPaint;-><init>()V

    iput-object p1, p0, Lcom/oplus/anim/model/layer/SolidLayer;->paint:Landroid/graphics/Paint;
...
.method public addValueCallback(Ljava/lang/Object;Lcom/oplus/anim/value/EffectiveValueCallback;)V
    ...
    iput-object p1, p0, Lcom/oplus/anim/model/layer/SolidLayer;->colorFilterAnimation:Lcom/oplus/anim/animation/keyframe/BaseKeyframeAnimation;
...
.method public drawLayer(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
    ...
    iget-object v0, p0, Lcom/oplus/anim/model/layer/SolidLayer;->layerModel:Lcom/oplus/anim/model/layer/Layer;

    invoke-virtual {v0}, Lcom/oplus/anim/model/layer/Layer;->getSolidColor()I
    ...
    iget-object v0, p0, Lcom/oplus/anim/model/layer/SolidLayer;->colorFilterAnimation:Lcom/oplus/anim/animation/keyframe/BaseKeyframeAnimation;

    if-eqz v0, :cond_4a

    iget-object v1, p0, Lcom/oplus/anim/model/layer/SolidLayer;->paint:Landroid/graphics/Paint;
    ...
    iget-object p3, p0, Lcom/oplus/anim/model/layer/SolidLayer;->points:[F
    ...
    iget-object v3, p0, Lcom/oplus/anim/model/layer/SolidLayer;->layerModel:Lcom/oplus/anim/model/layer/Layer;

    invoke-virtual {v3}, Lcom/oplus/anim/model/layer/Layer;->getSolidWidth()I
    ...
    iget-object v5, p0, Lcom/oplus/anim/model/layer/SolidLayer;->layerModel:Lcom/oplus/anim/model/layer/Layer;

    invoke-virtual {v5}, Lcom/oplus/anim/model/layer/Layer;->getSolidWidth()I
    ...
    invoke-virtual {v5}, Lcom/oplus/anim/model/layer/Layer;->getSolidHeight()I
    ...
    invoke-virtual {v1}, Lcom/oplus/anim/model/layer/Layer;->getSolidHeight()I
    ...
    iget-object p2, p0, Lcom/oplus/anim/model/layer/SolidLayer;->path:Landroid/graphics/Path;
    ...
    iget-object p0, p0, Lcom/oplus/anim/model/layer/SolidLayer;->paint:Landroid/graphics/Paint;
...
.method public getBounds(Landroid/graphics/RectF;Landroid/graphics/Matrix;Z)V
    ...
    iget-object p2, p0, Lcom/oplus/anim/model/layer/SolidLayer;->rect:Landroid/graphics/RectF;

    iget-object p3, p0, Lcom/oplus/anim/model/layer/SolidLayer;->layerModel:Lcom/oplus/anim/model/layer/Layer;

    invoke-virtual {p3}, Lcom/oplus/anim/model/layer/Layer;->getSolidWidth()I
    ...
    invoke-virtual {v0}, Lcom/oplus/anim/model/layer/Layer;->getSolidHeight()I
    ...
    iget-object p3, p0, Lcom/oplus/anim/model/layer/SolidLayer;->rect:Landroid/graphics/RectF;

    invoke-virtual {p2, p3}, Landroid/graphics/Matrix;->mapRect(Landroid/graphics/RectF;)Z

    iget-object p0, p0, Lcom/oplus/anim/model/layer/SolidLayer;->rect:Landroid/graphics/RectF;
