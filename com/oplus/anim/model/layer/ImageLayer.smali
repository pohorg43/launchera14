...
.field private imageAnimation:Lcom/oplus/anim/animation/keyframe/BaseKeyframeAnimation;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public constructor <init>(Lcom/oplus/anim/EffectiveAnimationDrawable;Lcom/oplus/anim/model/layer/Layer;)V
    ...
    invoke-direct {p1, p2}, Lcom/oplus/anim/animation/LPaint;-><init>(I)V

    iput-object p1, p0, Lcom/oplus/anim/model/layer/ImageLayer;->paint:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lcom/oplus/anim/model/layer/ImageLayer;->src:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lcom/oplus/anim/model/layer/ImageLayer;->dst:Landroid/graphics/Rect;
...
.method private getBitmap()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lcom/oplus/anim/model/layer/ImageLayer;->imageAnimation:Lcom/oplus/anim/animation/keyframe/BaseKeyframeAnimation;
    ...
    invoke-virtual {p0, v0}, Lcom/oplus/anim/EffectiveAnimationDrawable;->getImageAsset(Ljava/lang/String;)Landroid/graphics/Bitmap;
...
.method public addValueCallback(Ljava/lang/Object;Lcom/oplus/anim/value/EffectiveValueCallback;)V
    ...
    iput-object v1, p0, Lcom/oplus/anim/model/layer/ImageLayer;->colorFilterAnimation:Lcom/oplus/anim/animation/keyframe/BaseKeyframeAnimation;
    ...
    iput-object p1, p0, Lcom/oplus/anim/model/layer/ImageLayer;->colorFilterAnimation:Lcom/oplus/anim/animation/keyframe/BaseKeyframeAnimation;

    goto :goto_25

    :cond_15
    sget-object v0, Lcom/oplus/anim/EffectiveAnimationProperty;->IMAGE:Landroid/graphics/Bitmap;

    if-ne p1, v0, :cond_25

    if-nez p2, :cond_1e

    iput-object v1, p0, Lcom/oplus/anim/model/layer/ImageLayer;->imageAnimation:Lcom/oplus/anim/animation/keyframe/BaseKeyframeAnimation;
    ...
    iput-object p1, p0, Lcom/oplus/anim/model/layer/ImageLayer;->imageAnimation:Lcom/oplus/anim/animation/keyframe/BaseKeyframeAnimation;
...
.method public drawLayer(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
    ...
    iget-object p3, p0, Lcom/oplus/anim/model/layer/ImageLayer;->colorFilterAnimation:Lcom/oplus/anim/animation/keyframe/BaseKeyframeAnimation;
    ...
    iget-object p2, p0, Lcom/oplus/anim/model/layer/ImageLayer;->src:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, Lcom/oplus/anim/model/layer/ImageLayer;->dst:Landroid/graphics/Rect;
    ...
    iget-object p3, p0, Lcom/oplus/anim/model/layer/ImageLayer;->dst:Landroid/graphics/Rect;

    iget-object p0, p0, Lcom/oplus/anim/model/layer/ImageLayer;->paint:Landroid/graphics/Paint;
