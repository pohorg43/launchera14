...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lcom/oplus/anim/utils/Utils$1;

    invoke-direct {v0}, Lcom/oplus/anim/utils/Utils$1;-><init>()V

    sput-object v0, Lcom/oplus/anim/utils/Utils;->threadLocalPathMeasure:Ljava/lang/ThreadLocal;

    new-instance v0, Lcom/oplus/anim/utils/Utils$2;

    invoke-direct {v0}, Lcom/oplus/anim/utils/Utils$2;-><init>()V

    sput-object v0, Lcom/oplus/anim/utils/Utils;->threadLocalTempPath:Ljava/lang/ThreadLocal;

    new-instance v0, Lcom/oplus/anim/utils/Utils$3;

    invoke-direct {v0}, Lcom/oplus/anim/utils/Utils$3;-><init>()V

    sput-object v0, Lcom/oplus/anim/utils/Utils;->threadLocalTempPath2:Ljava/lang/ThreadLocal;

    new-instance v0, Lcom/oplus/anim/utils/Utils$4;

    invoke-direct {v0}, Lcom/oplus/anim/utils/Utils$4;-><init>()V

    sput-object v0, Lcom/oplus/anim/utils/Utils;->threadLocalPoints:Ljava/lang/ThreadLocal;
    ...
    sput v0, Lcom/oplus/anim/utils/Utils;->INV_SQRT_2:F
...
.method public static applyTrimPathIfNeeded(Landroid/graphics/Path;FFF)V
    ...
    sget-object v1, Lcom/oplus/anim/utils/Utils;->threadLocalPathMeasure:Ljava/lang/ThreadLocal;
    ...
    sget-object v2, Lcom/oplus/anim/utils/Utils;->threadLocalTempPath:Ljava/lang/ThreadLocal;
    ...
    sget-object v3, Lcom/oplus/anim/utils/Utils;->threadLocalTempPath2:Ljava/lang/ThreadLocal;
    ...
    invoke-static {v5, v4}, Lcom/oplus/anim/utils/MiscUtils;->floorMod(FF)I

    move-result p2

    int-to-float v5, p2

    invoke-static {p1, v4}, Lcom/oplus/anim/utils/MiscUtils;->floorMod(FF)I
...
.method public static applyTrimPathIfNeeded(Landroid/graphics/Path;Lcom/oplus/anim/animation/content/TrimPathContent;)V
    ...
    check-cast p1, Lcom/oplus/anim/animation/keyframe/FloatKeyframeAnimation;

    invoke-virtual {p1}, Lcom/oplus/anim/animation/keyframe/FloatKeyframeAnimation;->getFloatValue()F
    ...
    invoke-static {p0, v0, v1, p1}, Lcom/oplus/anim/utils/Utils;->applyTrimPathIfNeeded(Landroid/graphics/Path;FFF)V
...
.method public static getScale(Landroid/graphics/Matrix;)F
    ...
    sget-object v0, Lcom/oplus/anim/utils/Utils;->threadLocalPoints:Ljava/lang/ThreadLocal;
    ...
    sget v2, Lcom/oplus/anim/utils/Utils;->INV_SQRT_2:F
...
.method public static renderPath(Landroid/graphics/Path;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v2}, Lcom/oplus/anim/animation/LPaint;-><init>()V
...
.method public static saveLayerCompat(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/oplus/anim/utils/Utils;->saveLayerCompat(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;I)V
