...
.method public bridge synthetic a(Li6/d;Li6/f;)Li6/p$a;
    ...
    invoke-virtual {p0, p1, p2}, Lc6/d$b;->i(Li6/d;Li6/f;)Lc6/d$b;
...
.method public build()Li6/p;
    ...
    invoke-virtual {p0}, Lc6/d$b;->g()Lc6/d;

    move-result-object p0

    invoke-virtual {p0}, Lc6/d;->isInitialized()Z
...
.method public bridge synthetic e(Li6/h;)Li6/h$b;
    ...
    invoke-virtual {p0, p1}, Lc6/d$b;->h(Lc6/d;)Lc6/d$b;

    return-object p0
.end method

.method public g()Lc6/d;
    .registers 5
    ...
    invoke-direct {v0, p0, v1}, Lc6/d;-><init>(Li6/h$c;La4/c;)V
    ...
    :goto_f
    iget v2, p0, Lc6/d$b;->e:I

    iput v2, v0, Lc6/d;->d:I
    ...
    iput-object v1, p0, Lc6/d$b;->f:Ljava/util/List;

    iget v1, p0, Lc6/d$b;->d:I

    and-int/lit8 v1, v1, -0x3

    iput v1, p0, Lc6/d$b;->d:I
    ...
    iget-object v1, p0, Lc6/d$b;->g:Ljava/util/List;

    invoke-static {v1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lc6/d$b;->g:Ljava/util/List;
    ...
    iput-object p0, v0, Lc6/d;->f:Ljava/util/List;

    iput v3, v0, Lc6/d;->c:I

    return-object v0
.end method

.method public h(Lc6/d;)Lc6/d$b;
    .registers 5
    ...
    iget v0, p1, Lc6/d;->d:I

    iget v2, p0, Lc6/d$b;->d:I
    ...
    :cond_19
    iget-object v0, p1, Lc6/d;->e:Ljava/util/List;
    ...
    iget-object v0, p0, Lc6/d$b;->f:Ljava/util/List;
    ...
    iget-object v2, p0, Lc6/d$b;->f:Ljava/util/List;
    ...
    iget-object v1, p1, Lc6/d;->e:Ljava/util/List;

    invoke-interface {v0, v1}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    :cond_4f
    :goto_4f
    iget-object v0, p1, Lc6/d;->f:Ljava/util/List;
    ...
    iget-object v1, p1, Lc6/d;->f:Ljava/util/List;
    ...
    iget-object p1, p1, Lc6/d;->b:Li6/c;
...
.method public i(Li6/d;Li6/f;)Lc6/d$b;
    .registers 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :try_start_1
    sget-object v1, Lc6/d;->j:Li6/r;

    check-cast v1, Lc6/d$a;

    invoke-virtual {v1, p1, p2}, Lc6/d$a;->a(Li6/d;Li6/f;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Lc6/d$b;->h(Lc6/d;)Lc6/d$b;
