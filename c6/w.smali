...
# static fields
.field public static final e:Lc6/w;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lc6/w$a;-><init>()V

    sput-object v0, Lc6/w;->f:Li6/r;

    new-instance v0, Lc6/w;

    invoke-direct {v0}, Lc6/w;-><init>()V

    sput-object v0, Lc6/w;->e:Lc6/w;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lc6/w;->b:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lc6/w;->c:B

    iput v0, p0, Lc6/w;->d:I

    sget-object v0, Li6/c;->a:Li6/c;

    iput-object v0, p0, Lc6/w;->a:Li6/c;
...
.method public constructor <init>(Li6/d;Li6/f;La4/c;)V
    ...
    iput-byte p3, p0, Lc6/w;->c:B

    iput p3, p0, Lc6/w;->d:I

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object p3

    iput-object p3, p0, Lc6/w;->b:Ljava/util/List;
    ...
    iput-object v4, p0, Lc6/w;->b:Ljava/util/List;

    or-int/lit8 v3, v3, 0x1

    :cond_39
    iget-object v4, p0, Lc6/w;->b:Ljava/util/List;

    sget-object v5, Lc6/v;->l:Li6/r;
    ...
    iget-object p2, p0, Lc6/w;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lc6/w;->b:Ljava/util/List;
    ...
    iput-object p2, p0, Lc6/w;->a:Li6/c;
    ...
    iget-object p1, p0, Lc6/w;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lc6/w;->b:Ljava/util/List;
    ...
    iput-object p1, p0, Lc6/w;->a:Li6/c;
...
.method public constructor <init>(Li6/h$b;La4/c;)V
    ...
    iput-byte p2, p0, Lc6/w;->c:B

    iput p2, p0, Lc6/w;->d:I
...
.method public static e(Lc6/w;)Lc6/w$b;
    .registers 2
...
.method public b(Li6/e;)V
    ...
    invoke-virtual {p0}, Lc6/w;->getSerializedSize()I

    const/4 v0, 0x0

    :goto_4
    iget-object v1, p0, Lc6/w;->b:Ljava/util/List;
    ...
    :cond_1b
    iget-object p0, p0, Lc6/w;->a:Li6/c;
...
.method public f()Lc6/w$b;
    .registers 1

    invoke-static {p0}, Lc6/w;->e(Lc6/w;)Lc6/w$b;
...
.method public getSerializedSize()I
    ...
    :goto_8
    iget-object v2, p0, Lc6/w;->b:Ljava/util/List;
    ...
    :cond_21
    iget-object v0, p0, Lc6/w;->a:Li6/c;
...
.method public newBuilderForType()Li6/p$a;
    ...
    new-instance p0, Lc6/w$b;

    invoke-direct {p0}, Lc6/w$b;-><init>()V
