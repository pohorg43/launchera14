...
.method private static final buildIndex(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-static {v2, v1}, Li4/v;->b0(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Lkotlin/jvm/functions/Function1;)Lokio/ZipFileSystem;
    ...
    move-result-object v10
    :try_end_38
    .catchall {:try_start_19 .. :try_end_38} :catchall_16b
    ...
    :try_end_4e
    .catchall {:try_start_38 .. :try_end_4e} :catchall_14b
    ...
    move-result-object v4
    :try_end_62
    .catchall {:try_start_4e .. :try_end_62} :catchall_16b
    ...
    move-result-object v5
    :try_end_84
    .catchall {:try_start_62 .. :try_end_84} :catchall_d1
    ...
    move-result-object v8
    :try_end_91
    .catchall {:try_start_84 .. :try_end_91} :catchall_bc

    :try_start_91
    invoke-static {v5, v11}, Ls4/b;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_94
    .catchall {:try_start_91 .. :try_end_94} :catchall_d1
    ...
    throw v0
    :try_end_bc
    .catchall {:try_start_95 .. :try_end_bc} :catchall_bc
    ...
    throw v0
    :try_end_cd
    .catchall {:try_start_c1 .. :try_end_cd} :catchall_d1

    :cond_cd
    :goto_cd
    :try_start_cd
    invoke-static {v4, v11}, Ls4/b;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_d0
    .catchall {:try_start_cd .. :try_end_d0} :catchall_16b
    ...
    move-result-object v5
    :try_end_eb
    .catchall {:try_start_d6 .. :try_end_eb} :catchall_16b
    ...
    throw v0
    :try_end_11e
    .catchall {:try_start_eb .. :try_end_11e} :catchall_12e
    ...
    :try_end_12a
    .catchall {:try_start_11e .. :try_end_12a} :catchall_16b

    invoke-static {v3, v11}, Ls4/b;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    throw v0
    :try_end_16b
    .catchall {:try_start_133 .. :try_end_16b} :catchall_16b
    ...
    invoke-static {v3, v1}, Ls4/b;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public static final readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;
    ...
    invoke-static {v2, v0, v0, v1}, Lk7/q;->u(Ljava/lang/CharSequence;CZI)Z
    ...
    new-instance v2, Lokio/internal/ZipFilesKt$readEntry$1;
    ...
    invoke-static {v8, v15, v13}, Lokio/internal/ZipFilesKt;->readExtra(Lokio/BufferedSource;ILkotlin/jvm/functions/Function2;)V
    ...
    invoke-static {v9, v2, v4, v0}, Lk7/m;->j(Ljava/lang/String;Ljava/lang/String;ZI)Z
